...
public class Corporal implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2624317112678129165L;

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "sec_corporal")
	@GenericGenerator(name = "sec_corporal", strategy = "native")

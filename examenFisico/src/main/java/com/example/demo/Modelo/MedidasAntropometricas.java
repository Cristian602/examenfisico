...
public class MedidasAntropometricas implements Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = 8841249457255309435L;
	@Id
	@GeneratedValue (strategy = GenerationType.AUTO, generator = "sec_medidasAntro")
	@GenericGenerator(name = "sec_medidasAntro", strategy = "native")
